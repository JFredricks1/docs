...
![Logical Architecture Diagram](Capstone-SAIQA/img/Logical_Architecture.png)

### Physical Architecture
![Physical Architecture Diagram](Capstone-SAIQA/img/Physical_Architecture.png)

### Deployment Diagram
![Deployment Diagram](Capstone-SAIQA/img/Deployment_Diagram.png)

### Database
![ER Diagram](Capstone-SAIQA/img/ER_Diagram.png/))

### Sitemap
![Sitemap Diagram](Capstone-SAIQA/img/Sitemap.png)
